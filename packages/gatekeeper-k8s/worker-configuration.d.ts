/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a332e8e20ab6bfc9628673e36c8c9a4)
// Runtime types generated with workerd@1.20260801.1 2026-02-02 allow_irrevocable_stub_storage,nodejs_als
interface __BaseEnv_Env {
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.wrangler/validate/src/worker");
		durableNamespaces: "K8sGatekeeper";
	}
	interface Env extends __BaseEnv_Env {
		K8S_READ_TOKEN?: string;
		K8S_ARGOCD_TOKEN?: string;
		K8S_PROXY_TOKEN?: string;
		K8S_API_PROXY?: string;
		ARGOCD_API_PROXY?: string;
		K8S_API_SERVER?: string;
		ARGOCD_API_SERVER?: string;
	}
}
interface Env extends __BaseEnv_Env {}
declare module "*.txt" {
